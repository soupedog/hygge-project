 ...
 * @since 1.0
 */
public class PropertiesPrimaryAnalyst implements ConfigurationTypeAnalyst {
    @Override
    public ConfigurationType typeResult() {
        return PropertiesDefaultConfigurationType.PRIMARY;
    }
    ...
    public boolean isMatched(PropertiesArrangerConfiguration configuration, String key) {
        ...
        return configuration.getPrimaryKey().contains(key);
    }
}
